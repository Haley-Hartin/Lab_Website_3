...
app.get('/team_stats', function(req, res) {
	var games = "select * from football_games;";
  	var wins = "select count(*) from football_games where home_score > visitor_score;";
        ...
        db.task("get-everything", task => {
        return task.batch([task.any(games), 
               task.any(wins),
               task.any(losses)]);
      })
      .then(info => {
...
app.get('/player_info', function(req,res) {
  var p_info = 'select id,name from football_players;';
...
app.get('/player_info/post', function(req,res){
  var ident = req.query.player_choice;
  var player1 = 'select id,name from football_players;';
  var player2 = "select * from football_players where name='"+ident+"';";
  var player3 = "select count(*) from football_games where (select id from football_players where name = '"+ident+"')= any(players);"
